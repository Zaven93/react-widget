...
!(function (e, t) {
  ...
  var d = (function (n) {
    ...
    try {
      O.apply((L = F.call(N.childNodes)), N.childNodes),
      ...
      if (!r && v) {
        if (11 !== i && (l = ee.exec(e)))
          if ((c = l[1])) {
            ...
            if ((c = l[3]) && p.getElementsByClassName)
              return O.apply(n, t.getElementsByClassName(c)), n;
          }
        if (p.qsa && (!y || !y.test(e))) {
          if (
            ((u = a = C),
              ...
              ? function (e, t) {
                  ...
                  return (
                    ...
                    (!p.sortDetached && t.compareDocumentPosition(e) === n)
                      ? e === u || (e.ownerDocument === N && x(N, e))
                        ? -1
                        : t === u || (t.ownerDocument === N && x(N, t))
                        ? 1
                        : l
                        ? P(l, e) - P(l, t)
                        : 0
    ...
    (ie.matchesSelector = function (e, t) {
      if (
        ...
        (t = t.replace(V, "='$1']")),
        !(!p.matchesSelector || !v || (s && s.test(t)) || (y && y.test(t))))
      )
        try {
          var n = a.call(e, t);
          if (
    ...
    return (
      ...
      (g = ie.select =
        function (e, t, n, r) {
            ...
            for (
              ...
              if (
                ...
                (r = u(
                  ...
                  (te.test(o[0].type) && fe(t.parentNode)) || t
                ))
              ) {
          ...
          return (
            (l || h(e, c))(r, t, !v, n, (te.test(e) && fe(t.parentNode)) || t),
            n
          );
        }),
  ...
  (w.fn.init = function (e, t) {
    ...
    if (
      ...
      return (!t || t.jquery ? t || k : this.constructor(t)).find(e);
    if (n[1]) {
      if (
        ...
        w.fn[r] = function (e, t) {
          ...
          return (
            (t = "Until" !== r.slice(-5) ? e : t) &&
              "string" == typeof t &&
              (n = w.filter(t, n)),
            1 < this.length && (S[r] || w.unique(n), E.test(r) && n.reverse()),
            this.pushStack(n)
          );
        };
      }
  ...
  (w.Callbacks = function (i) {
    ...
    function r(e) {
      for (
        t = i.memory && e, o = !0, l = a || 0, a = 0, u = c.length, s = !0;
        c && l < u;
        l++
      )
      ...
      (s = !1),
        c && (f ? f.length && r(f.shift()) : t ? (c = []) : p.disable());
    }
    var t,
      o,
      s,
    ...
    w.extend({
      ...
      ready: function (e) {
        (!0 === e ? --w.readyWait : w.isReady) ||
          ...
          (j.resolveWith(y, [w]),
          w.fn.triggerHandler &&
            (w(y).triggerHandler("ready"), w(y).off("ready")));
      },
    }),
  ...
  var n = /[+-]?(?:\d*\.|)\d+(?:[eE][+-]?\d+|)/.source,
    ...
    B = /^(?:checkbox|radio)$/i;
  (s = y.createDocumentFragment().appendChild(y.createElement("div"))),
    (d = y.createElement("input")).setAttribute("type", "radio"),
  ...
  (w.event = {
    ...
    fix: function (e) {
      ...
      for (
        s ||
          (this.fixHooks[i] = s =
            X.test(i) ? this.mouseHooks : z.test(i) ? this.keyHooks : {}),
  ...
  (oe.optgroup = oe.option),
    ...
    w.extend({
        ...
        if (
          ...
          for (s = fe(c), r = 0, i = (o = fe(e)).length; r < i; r++)
            (a = o[r]),
              (u = s[r]),
              (l = void 0),
              "input" === (l = u.nodeName.toLowerCase()) && B.test(a.type)
                ? (u.checked = a.checked)
                : ("input" !== l && "textarea" !== l) ||
      ...
      cleanData: function (e) {
        for (
          var t, n, r, i, o = w.event.special, s = 0;
          void 0 !== (n = e[s]);
          s++
        ) {
  ...
  function he(e, t) {
    var t = w(t.createElement(e)).appendTo(t.body),
      n =
        h.getDefaultComputedStyle && (n = h.getDefaultComputedStyle(t[0]))
          ? n.display
          : w.css(t[0], "display");
    return t.detach(), n;
  }
  ...
  function me(e) {
    return (
      e.ownerDocument.defaultView.opener ? e.ownerDocument.defaultView : h
  ...
  function Ne(e, t, n) {
    var r,
      ...
      o = e.style;
    return (
      (n = n || me(e)) && (i = n.getPropertyValue(t) || n[t]),
      n &&
  ...
  (xe = y.documentElement),
    ...
    (we = y.createElement("div")).style &&
      ((we.style.backgroundClip = "content-box"),
      (we.cloneNode(!0).style.backgroundClip = ""),
      (v.clearCloneStyle = "content-box" === we.style.backgroundClip),
      (be.style.cssText =
      ...
      h.getComputedStyle &&
        w.extend(v, {
          ...
          reliableMarginRight: function () {
            var e,
              t = we.appendChild(y.createElement("div"));
            return (
              (t.style.cssText = we.style.cssText =
  ...
  function Fe(e, t, n, r, i) {
    for (
      ...
      "margin" === n && (s += w.css(e, n + I[o], !0, i)),
        r
          ? ("content" === n && (s -= w.css(e, "padding" + I[o], !0, i)),
            "margin" !== n && (s -= w.css(e, "border" + I[o] + "Width", !0, i)))
          : ((s += w.css(e, "padding" + I[o], !0, i)),
            "padding" !== n &&
              (s += w.css(e, "border" + I[o] + "Width", !0, i)));
    return s;
  }
  function Pe(e, t, n) {
    var r = !0,
    ...
    if (i <= 0 || null == i) {
      if (
        (((i = Ne(e, t, o)) < 0 || null == i) && (i = e.style[t]), Ce.test(i))
      )
        return i;
  ...
  w.extend({
      ...
      return (
        ...
        "normal" ===
          (i =
            void 0 ===
            (i =
              (o = w.cssHooks[t] || w.cssHooks[o]) && "get" in o
                ? o.get(e, !0, n)
                : i)
              ? Ne(e, t, r)
              : i) &&
    ...
    w.each(["height", "width"], function (e, i) {
      w.cssHooks[i] = {
        get: function (e, t, n) {
          return t
            ? Se.test(w.css(e, "display")) && 0 === e.offsetWidth
    ...
    (((w.Tween = Me).prototype = {
      ...
      run: function (e) {
        ...
        return (
          ...
          (n && n.set ? n : Me.propHooks._default).set(this),
          this
        );
      },
    ...
    ze = [
      function (t, e, n) {
        ...
        1 === t.nodeType &&
          ...
          (l = w.css(t, "display")),
          "inline" ===
            ("none" === l ? F.get(t, "olddisplay") || ge(t.nodeName) : l) &&
            "none" === w.css(t, "float") &&
        ...
        if (w.isEmptyObject(f))
          "inline" === ("none" === l ? ge(t.nodeName) : l) && (p.display = l);
        else
          for (r in (h
        ...
        function (e, t) {
          var n = this.createTween(e, t),
            ...
            o =
              ...
              Be.exec(w.css(n.elem, e)),
            s = 1,
            a = 20;
          if (o && o[3] !== i)
            for (
              i = i || o[3], t = t || [], o = +r || 1;
              w.style(n.elem, e, (o /= s = s || ".5") + i),
                s !== (s = n.cur() / r) && 1 !== s && --a;
  ...
  (w.Animation = w.extend(Ge, {
    ...
    (s = y.createElement("select")),
    (n = s.appendChild(y.createElement("option"))),
    (d.type = "checkbox"),
    (v.checkOn = "" !== d.value),
        ...
        select: {
          ...
          set: function (e, t) {
            for (
              ...
              ((r = i[s]).selected = 0 <= w.inArray(r.value, o)) && (n = !0);
  ...
  (w.fn.load = function (e, t, n) {
    ...
    var r,
      ...
      a = e.indexOf(" ");
    return (
      0 <= a && ((r = w.trim(e.slice(a))), (e = e.slice(0, a))),
      w.isFunction(t)
        ? ((n = t), (t = void 0))
  ...
  (w.offset = {
    setOffset: function (e, t, n) {
      ...
      "static" === a && (e.style.position = "relative"),
        ...
        null != (t = w.isFunction(t) ? t.call(e, n, o) : t).top &&
          (l.top = t.top - o.top + i),
        ...
        if (this[0]) {
          ...
          return (
            "fixed" === w.css(n, "position")
              ...
              : ((e = this.offsetParent()),
                (t = this.offset()),
                ((r = !w.nodeName(e[0], "html") ? e.offset() : r).top += w.css(
                  e[0],
                  "borderTopWidth",
                  !0
                )),
    ...
    w.each(["top", "left"], function (e, n) {
      w.cssHooks[n] = ke(v.pixelPosition, function (e, t) {
        return t
          ? ((t = Ne(e, n)), Ce.test(t) ? w(e).position()[n] + "px" : t)
          : void 0;
      });
    }),

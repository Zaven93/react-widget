    ...
    (i.prototype.generateLayoutClass = function () {
      if (this.settings) {
        ...
        var e = "",
          t = t.column_span;
        return (
          1 == parseInt(t.xs.use, 10) &&
            ((e += t.xs.class + " "),
            0 == parseInt(t.xs.visible, 10) && (e += "sq-hidden-sm ")),
          1 == parseInt(t.sm.use, 10) &&
            ((e += t.sm.class + " "),
            0 == parseInt(t.sm.visible, 10) && (e += "sq-hidden-md ")),
          1 == parseInt(t.md.use, 10) &&
            ((e += t.md.class + " "),
            0 == parseInt(t.md.visible, 10) && (e += "sq-hidden-lg ")),
          1 == parseInt(t.lg.use, 10) &&
            ((e += t.lg.class + " "),
            0 == parseInt(t.lg.visible, 10) && (e += "sq-hidden-xl ")),
          e
        );
      }
    }),
...
!(function ($, window, document, undefined) {
  ...
  ($.imageMapProInitialized = function (t) {}),
    ...
    ($.imageMapProFocusShape = function (t, i) {
      ...
      !n ||
        ((i = findShapeWithTitle(n.settings.general.name, i)) &&
          ((e = i.shape),
          (s = i.index),
    ...
    ($.imageMapProOpenTooltip = function (t, i) {
      ...
      !s ||
        ((i = findShapeWithTitle(s.settings.general.name, i)) &&
          (i.shape,
          (e = i.index),
          APIFunctionQueueAddAction(function (t) {
            s.showTooltip(e), t();
  ...
  $.extend(Plugin.prototype, {
    ...
    drawShapes: function () {
      for (var t = 0; t < this.settings.spots.length; t++)
        if (
          (((f = this.settings.spots[t]).x = parseFloat(f.x)),
          (f.y = parseFloat(f.y)),
          (f.width = parseFloat(f.width)),
          (f.height = parseFloat(f.height)),
          (f.default_style.stroke_width = parseInt(
            f.default_style.stroke_width
          )),
          (f.mouseover_style.stroke_width = parseInt(
            f.mouseover_style.stroke_width
          )),
          "poly" === f.type)
        )
          for (var i = 0; i < f.points.length; i++)
            (f.points[i].x = parseFloat(f.points[i].x)),
              (f.points[i].y = parseFloat(f.points[i].y));
      ...
      for (
        ...
        if (
          ...
          var o,
            ...
            g = "";
          if (
            (isTrue((f = this.settings.spots[t]).static) &&
              (g = "imp-shape-static"),
            "spot" === f.type &&
              (isTrue(f.default_style.use_icon)
                ? ((o = "imp-shape-spot"),
                  isTrue(f.default_style.icon_is_pin) &&
                  ...
                  (e +=
                    ...
                    t +
                    ">"),
                  "library" === f.default_style.icon_type &&
                    ((h = ""),
                    (h += "line-height: " + f.height + "px;"),
                    (e +=
                      '   <div class="imp-spot-fontawesome-icon" style="' +
                      (h += "font-size: " + f.height + "px;") +
                      '">'),
                    (e +=
                      '       <i class="fa fa-' +
                      f.default_style.icon_fontawesome_id +
                      '"></i>'),
                    (e += "   </div>")),
                  "custom" === f.default_style.icon_type &&
                    0 < f.default_style.icon_url.length &&
                    (e +=
                      '<img src="' +
                      f.default_style.icon_url +
                      '" style="width: ' +
                      f.width +
                      "px; height: " +
                      f.height +
                      'px">'),
                  isTrue(f.default_style.icon_shadow) &&
                    ((h = ""),
                    (h += "width: " + f.width + "px;"),
                    (h += "height: " + f.height + "px;"),
                    (e +=
                      '<div style="' +
                      (h += "top: " + f.height / 2 + "px;") +
                  ...
                  isTrue(this.settings.shapes.glowing_shapes) &&
                    ((p = ""),
                    (p += "width: " + f.width / 3 + "px;"),
                    (p += "height: " + f.height / 3 + "px;"),
                    (p += "margin-left: " + -f.width / 6 + "px;"),
                    (p += "margin-top: " + -f.height / 6 + "px;"),
                    (p += "border-radius: " + f.width / 3 + "px;"),
                    (p +=
                      "background: rgba(" +
                      (l = hexToRgb(
            ...
            "rect" === f.type &&
              ...
              isTrue(this.settings.shapes.glowing_shapes) &&
                ...
                (p +=
                  "box-shadow: 0 0 20px 15px rgba(" +
                  (l = hexToRgb(this.settings.shapes.glowing_shapes_color) || {
                    r: 0,
                    b: 0,
                    g: 0,
                  }).r +
                ...
                (r +=
                  '<div class="imp-shape-glow" style="' +
                  (p +=
                    "border-radius: " + f.default_style.border_radius + "px;") +
                  '"></div>')),
              (e +=
                '<div class="imp-shape ' +
                g +
      ...
      a += "</svg>";
      for (var f, y, v = "", t = 0; t < this.settings.spots.length; t++)
        (isTrue(this.settings.layers.enable_layers) &&
          parseInt(this.settings.spots[t].layerID, 10) !==
            parseInt(this.settings.runtime.layerID)) ||
          ((y = ""),
          (y +=
            "left: " +
            ((f = this.settings.spots[t]).x_image_background +
              f.default_style.background_image_offset_x) +
            "%;"),
          (y +=
            "top: " +
            (f.y_image_background + f.default_style.background_image_offset_y) +
            "%;"),
          (y += "width: " + f.width_image_background + "%;"),
          (y += "height: " + f.height_image_background + "%;"),
          "image" === f.default_style.background_type &&
            f.default_style.background_image_url &&
            ((y +=
              "opacity: " + f.default_style.background_image_opacity + ";"),
            (y +=
              "transform: scale(" +
              f.default_style.background_image_scale +
              ");")),
          (v +=
        ...
        (t += "   </div>"),
          ...
          isTrue(this.settings.shapes_menu.detached_menu)
            ...
            ? (this.responsiveShapesMenuWrap ||
              ...
              (e += '<i class="fa fa-bars" aria-hidden="true"></i>'),
              this.ui.append((e += "</div>")),
      ...
      if (
        ...
        for (var e, s, n, a, t = "", i = 0; i < this.settings.spots.length; i++)
          "text" !== (e = this.settings.spots[i]).type &&
            ...
            (n += "border-radius: " + e.tooltip_style.border_radius + "px;"),
            (n += "padding: " + e.tooltip_style.padding + "px;"),
            (n +=
              "background: rgba(" +
              s.r +
    ...
    initFullscreen: function () {
      ...
      isTrue(this.settings.fullscreen.enable_fullscreen_mode) &&
        ...
        (t +=
          ...
          "; "),
        (e = '<i class="fa fa-arrows-alt" aria-hidden="true"></i>'),
        isTrue(this.settings.runtime.is_fullscreen) &&
          (e = '<i class="fa fa-times" aria-hidden="true"></i>'),
        (s = "Go Fullscreen"),
        isTrue(this.settings.runtime.is_fullscreen) && (s = "Close Fullscreen"),
        (i = ""),
        "icon" === this.settings.fullscreen.fullscreen_button_type && (i += e),
        "text" === this.settings.fullscreen.fullscreen_button_type && (i += s),
        "icon_and_text" === this.settings.fullscreen.fullscreen_button_type &&
          (i += e + " " + s),
        (e = ""),
        "icon" === this.settings.fullscreen.fullscreen_button_type &&
          (e += "imp-fullscreen-button-icon-only"),
        (s = ""),
        (s +=
          '<div data-imp-id="' +
          this.settings.id +
    ...
    isPointInsideVisibleTooltip: function (t) {
      for (var i = 0; i < this.openedTooltips.length; i++) {
        ...
        return (
          ...
          isPointInsidePolygon(e.x, e.y, s) ? !0 : !1
        );
      }
    },
    ...
    calcStyles: function (t, i) {
      ...
      return (
        "spot" === h.type &&
          ...
          this.didAnimateShapesOnPageload ||
            ("fall-down" === this.settings.shapes.pageload_animation
              ...
              : ("fade" === this.settings.shapes.pageload_animation
                  ? (r += "opacity: 0;")
                  : (r += "opacity: " + t.opacity + ";"),
                (r += "transform: scale(" + 1 / this.zoom + ");"))),
          (s = -h.width / 2),
          (e = -h.height / 2),
          isTrue(h.default_style.use_icon) ||
            ((n = hexToRgb(t.background_color) || { r: 0, b: 0, g: 0 }),
            (a = hexToRgb(t.border_color) || { r: 0, b: 0, g: 0 }),
            (r += "border-radius: " + t.border_radius + "px;"),
            (r +=
              "background: rgba(" +
              n.r +
              ", " +
              ...
              ");"),
            (r += "border-width: " + t.border_width + "px;"),
            (r += "border-style: " + t.border_style + ";"),
            (r +=
              "border-color: rgba(" +
              a.r +
              ", " +
              ...
              ");")),
          isTrue(h.default_style.use_icon) &&
            (isTrue(h.default_style.icon_is_pin) && (s = -h.height),
            "library" === h.default_style.icon_type &&
              (r +=
                "color: rgba(" +
                (i = hexToRgb(t.icon_fill) || { r: 0, b: 0, g: 0 }).r +
                ", " +
                i.g +
                ", " +
                i.b +
          ...
          (r += "margin-top: " + s + "px;")),
        "text" === h.type &&
          ((s = hexToRgb(h.text.text_color)),
          (r += "left: " + h.x + "%;"),
          (r += "top: " + h.y + "%;"),
          (r += "font-family: " + h.text.font_family + ";"),
          (r += "font-size: " + h.text.font_size + "px;"),
          (r += "font-weight: " + h.text.font_weight + ";"),
          (r +=
            "color: rgba(" +
            s.r +
            ", " +
          ...
          this.didAnimateShapesOnPageload ||
            ("grow" === this.settings.shapes.pageload_animation
              ...
              : ("fade" === this.settings.shapes.pageload_animation
                  ...
                  : (r += "opacity: " + t.opacity + ";"),
                (r += "transform: scale(" + 1 / this.zoom + ");")))),
        ("rect" !== h.type && "oval" !== h.type) ||
          ((o = t.border_radius + "px"),
          "oval" === h.type && (o = "50% 50%"),
          (n = hexToRgb(t.background_color) || { r: 0, b: 0, g: 0 }),
          (a = hexToRgb(t.border_color) || { r: 0, b: 0, g: 0 }),
          (r += "left: " + h.x + "%;"),
          ...
          this.didAnimateShapesOnPageload ||
            ("grow" === this.settings.shapes.pageload_animation
              ...
              : ("fade" === this.settings.shapes.pageload_animation
                  ...
                  : (r += "opacity: " + t.opacity + ";"),
                (r += "transform: scale(1);")))),
        ("poly" !== h.type && "path" !== h.type) ||
          ((o = hexToRgb(t.background_color) || { r: 0, b: 0, g: 0 }),
          (h = hexToRgb(t.stroke_color) || { r: 0, b: 0, g: 0 }),
          "color" === t.background_type
            ? (r +=
                "fill: rgba(" +
                o.r +
          ...
          (r +=
            ...
            t.stroke_opacity +
            ");"),
          (r += "stroke-width: " + t.stroke_width + "px;"),
          (r += "stroke-dasharray: " + t.stroke_dasharray + ";"),
          (r += "stroke-linecap: " + t.stroke_linecap + ";"),
          this.didAnimateShapesOnPageload ||
            ("fade" === this.settings.shapes.pageload_animation
              ? (r += "opacity: 0;")
              : (r += "opacity: " + t.opacity + ";"))),
    ...
    unhighlightShape: function (t) {
      ...
      (isTrue(this.settings.layers.enable_layers) &&
        ...
        (-1 == this.apiHighlightedShapes.indexOf(t) &&
          ...
          (t = this.highlightedShapes.indexOf(t)),
          this.highlightedShapes.splice(t, 1)));
    },
    ...
    focusShape: function (t) {
      if (isTrue(this.settings.zooming.enable_zooming)) {
        ...
        (l = (l / 100) * this.wrapWidth * n),
          (g = (g / 100) * this.wrapHeight * n),
          this.applyZoom(n),
          this.panTo(l, g);
      }
    },
    ...
    updateTooltipPosition: function (t, i) {
      ...
      this.fullscreenTooltipVisible ||
        ...
        (a = this.settings.spots[t]),
        (o = window.innerWidth),
        (t = window.innerHeight),
        isTrue(this.settings.tooltips.sticky_tooltips) && i
          ? ((p = (r = this.getEventCoordinates(i)).x),
            (d = r.y),
            (h = p - this.wrapOffsetLeft),
            (r = d - this.wrapOffsetTop),
            (d = p = 0))
          : ((p = (a.width / 100) * this.wrapWidth),
            (d = (a.height / 100) * this.wrapHeight),
            (p *= this.targetZoom),
            (d *= this.targetZoom),
            (h = (Math.round(10 * a.x) / 10 / 100) * this.wrapWidth),
            (r = (Math.round(10 * a.y) / 10 / 100) * this.wrapHeight),
            (h = h * this.targetZoom + this.targetPanX),
            (r = r * this.targetZoom + this.targetPanY)),
        "spot" === a.type &&
          ((h -= a.width / 2),
          isTrue(this.settings.tooltips.sticky_tooltips) || (r -= a.height / 2),
          (p = a.width),
          (d = a.height)),
        "spot" === a.type &&
          isTrue(a.default_style.icon_is_pin) &&
          "spot" === a.type &&
          isTrue(a.default_style.use_icon) &&
          !isTrue(this.settings.tooltips.sticky_tooltips) &&
          (r -= d / 2),
        isTrue(this.settings.runtime.is_fullscreen) &&
        isTrue(this.settings.tooltips.constrain_tooltips)
          ? (h + this.wrapOffsetLeft < 0 &&
            ...
            h + this.wrapOffsetLeft + p > o &&
              (p += o - (h + this.wrapOffsetLeft + p)),
            r + this.wrapOffsetTop < 0 &&
              ((d = d + r + this.wrapOffsetTop), (r = -this.wrapOffsetTop)),
            r + this.wrapOffsetTop + d > t &&
              (d += t - (r + this.wrapOffsetTop + d)))
          : (h < 0 && ((p += h), (h = 0)),
            h + p > this.wrapWidth && (p = this.wrapWidth - h),
            r < 0 && ((d += r), (r = 0)),
            r + d > this.wrapHeight && (d = this.wrapHeight - r)),
        "left" === a.tooltip_style.position &&
          ((l = h - s - 20), (g = r + d / 2 - n / 2)),
        "right" === a.tooltip_style.position &&
          ((l = h + p + 20), (g = r + d / 2 - n / 2)),
        "top" === a.tooltip_style.position &&
          ((l = h + p / 2 - s / 2), (g = r - n - 20)),
        "bottom" === a.tooltip_style.position &&
          ((l = h + p / 2 - s / 2), (g = r + d + 20)),
        (d = { x: l, y: g }),
        isTrue(this.settings.tooltips.constrain_tooltips) &&
          (((d = fitRectToScreen(
            l + this.wrapOffsetLeft,
            g + this.wrapOffsetTop,
            s,
            n
          )).x -= this.wrapOffsetLeft),
          (d.y -= this.wrapOffsetTop)),
        (d.x += (a.tooltip_style.offset_x / 100) * this.wrapWidth),
        (d.y += (a.tooltip_style.offset_y / 100) * this.wrapHeight),
        e.css({
          left:
            d.x + this.wrapOffsetLeft - this.tooltipsContainer.offset().left,
  ...
  (function (t) {
    ...
    var f = (l.event.special.mousewheel = {
      ...
      getLineHeight: function (t) {
        var i = l(t),
          t = i["offsetParent" in l.fn ? "offsetParent" : "parent"]();
        return (
          t.length || (t = l("body")),
